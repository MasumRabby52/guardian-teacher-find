    ...
    <footer className="bg-gray-50 pt-12 pb-8 border-t">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 gradient-text">TutorConnect</h3>
            <p className="text-gray-600 mb-4">
              Connecting passionate teachers with dedicated students for a brighter future.
            </p>
          </div>
          
          <div>
            <h4 className="font-semibold mb-4 text-gray-800">For Teachers</h4>
            <ul className="space-y-2">
              <li>
                <Link to="/become-tutor" className="text-gray-600 hover:text-brand-blue transition-colors">
                  Apply as Tutor
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/success-stories" className="text-gray-600 hover:text-brand-blue transition-colors">
                  Success Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-gray-800">For Guardians</h4>
            <ul className="space-y-2">
              <li>
                <Link to="/find-tutors" className="text-gray-600 hover:text-brand-blue transition-colors">
                  Find Tutors
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/testimonials" className="text-gray-600 hover:text-brand-blue transition-colors">
                  Testimonials
                </Link>
              </li>
            </ul>
